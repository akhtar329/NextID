...
export const posts = pgTable(
  "posts",
  {
    ...
    meta: jsonb("meta"),
    // Admission: { year, session, openDate, closeDate, eligibility, howToApply, feeStructure, officialLink, applicationLink, instituteId, instituteName }
    // Result: { year, examType, resultDate, officialLink, boardId, boardName, instituteId, instituteName }
    // News: { source, sourceUrl, tags, expiresAt }
    // DateSheet: { year, examType, examDate, officialLink, downloadLink, pdfFile, boardId, boardName }
    // Scholarship: { organizationName, amount, applicationDeadline, coverage, eligibility, instituteId }
    // Blog: { readingTime, tags }
