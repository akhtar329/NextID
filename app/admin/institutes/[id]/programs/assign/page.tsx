// app/admin/institutes/[id]/programs/assign/page.tsx
...
export default function InstituteProgramsAssignPage() {
    ...
    <div className="p-6 max-w-4xl mx-auto">
      ...
      <div className="mb-6">
        <div className="flex items-center text-sm text-gray-500 mb-2">
          ...
          <span className="mx-2">›</span>
          <span className="text-gray-700">Assign Programs</span>
        </div>

        <div className="flex items-center justify-between">
          <h1 className="text-2xl font-semibold">Assign Programs</h1>
      ...
      <div className="mb-4">
        <p className="text-sm text-gray-600">
          {selectedProgramIds.size} of {allPrograms.length} programs selected
        </p>
      </div>
