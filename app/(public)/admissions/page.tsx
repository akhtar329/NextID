      ...
      <div className="bg-gradient-to-r from-blue-600 to-blue-800 text-white py-16">
        <div className="container mx-auto px-4 text-center">
          <div className="inline-flex items-center gap-2 bg-white/10 backdrop-blur-sm px-4 py-2 rounded-full mb-4">
            ...
            <span className="text-sm">Admissions 2026</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-3">
            University Admissions
          </h1>
          <p className="text-lg text-blue-100 max-w-2xl mx-auto">
            {openAdmissions.length} admissions currently open across Pakistan
          </p>
        </div>
      </div>
      ...
      <div className="container mx-auto px-4 py-12">
        <div className="flex flex-col lg:flex-row gap-8">
          ...
          <main className="lg:w-2/3">
            ...
            {/* Featured Admissions - Clean Cards */}
            ...
            {/* All Admissions - Clean List */}
            <div>
              <h2 className="text-xl font-bold text-gray-800 mb-5 flex items-center gap-2">
                <span className="w-1 h-5 bg-blue-500 rounded-full"></span>
                All Admissions
                <span className="text-sm font-normal text-gray-500 ml-2">({admissions.length})</span>
              </h2>
