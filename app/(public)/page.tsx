...
// ==================== STATIC SCHEMA (No dynamic data needed) ====================
...
// FAQ Schema (Static - common questions)
const faqSchema = {
  "@context": "https://schema.org",
  "@type": "FAQPage",
  "mainEntity": [
    {
      "@type": "Question",
      "name": "When do university admissions start in Pakistan?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "University admissions in Pakistan typically start in July-August for Fall semester and December-January for Spring semester. Top universities like NUST, FAST, and LUMS announce admissions in March-April."
      }
    },
    {
      "@type": "Question",
      "name": "How can I check my board result online?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can check your board result online by visiting the official board website, entering your roll number, selecting exam year, and clicking Search. Most boards also offer SMS services for results."
      }
    },
    {
      "@type": "Question",
      "name": "How to download date sheets for exams?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can download date sheets from respective board or university websites. We provide direct download links for all major boards including FBISE, BISE Lahore, BISE Karachi, and universities across Pakistan."
      }
    },
    {
      "@type": "Question",
      "name": "What are the best scholarships for Pakistani students?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Popular scholarships include HEC Indigenous Scholarship, PEEF Scholarship, Ehsaas Undergraduate Scholarship, Commonwealth Scholarship, and university-specific scholarships for Pakistani students."
      }
    },
    {
      "@type": "Question",
      "name": "How to find teaching jobs in Pakistan?",
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "You can find teaching jobs through university career portals, job websites, newspaper advertisements, and our dedicated jobs section featuring faculty and administrative positions."
      }
    }
  ]
};

// ==================== PAGE COMPONENT WITH DYNAMIC SCHEMA ====================
export default async function HomePage() {
  ...
  // Dynamic Admissions Schema
  const admissionsSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Latest Admissions in Pakistan",
    "description": "We publish latest admissions from all major universities and institutions across Pakistan. Never lose a chance to get admission in a college/university of your choice.",
    "numberOfItems": admissionsList.length,
    "itemListElement": admissionsList
  };

  // Dynamic Results Schema
  const resultsSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Latest Board & University Results",
    "description": "Check all education board and university results for Matric, Intermediate, BA, BSc, MA, MSc in Pakistan.",
    "numberOfItems": resultsList.length,
    "itemListElement": resultsList
  };

  // Dynamic Date Sheets Schema
  const dateSheetsSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Exam Date Sheets 2026",
    "description": "Download official date sheets for Matric, Intermediate, and University exams across Pakistan.",
    "numberOfItems": dateSheetsList.length,
    "itemListElement": dateSheetsList
  };
  ...
  const jobsSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Latest Jobs in Pakistan",
    "description": "100s of new jobs are posted every week. Start a career of your dreams and keep yourself updated with all the new jobs announced in private and government sector across Pakistan.",
    "numberOfItems": jobsList.length,
    "itemListElement": jobsList
  };

  // Dynamic Scholarships Schema
  const scholarshipsSchema = {
    "@context": "https://schema.org",
    "@type": "ItemList",
    "name": "Scholarships for Pakistani Students",
    ...
    "numberOfItems": scholarshipsList.length,
    "itemListElement": scholarshipsList
  };
  ...
  return (
    <>
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(admissionsSchema) }}
      />
      <script
        type="application/ld+json"
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(dateSheetsSchema) }}
      />
      <script
        type="application/ld+json"
      ...
      <script
        type="application/ld+json"
        dangerouslySetInnerHTML={{ __html: JSON.stringify(scholarshipsSchema) }}
      />
      <script
        type="application/ld+json"
      ...
      <div className="min-h-screen bg-gray-50" suppressHydrationWarning>
        ...
        {/* Dynamic Quick Links Section - Also shows latest items */}
        <OnScrollLoad rootMargin="200px">
          <section className="bg-white py-12 border-t border-gray-200 mt-8">
            <div className="max-w-6xl mx-auto px-4">
              <div className="text-center mb-8">
                <h2 className="text-2xl md:text-3xl font-bold text-gray-800 mb-4">
                  Find & Compare Study Programs & Universities
                </h2>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-3 flex items-center gap-2">
                    <span className="text-blue-600">📝</span> Latest Admissions
                  </h3>
                  <ul className="space-y-2 text-sm">
                    {admissionsList.slice(0, 4).map((item: SchemaListItem, idx: number) => (
                      <li key={idx}>
                        <Link href={item.url} className="text-gray-600 hover:text-blue-600 line-clamp-1">
                          {item.name}
                        </Link>
                      </li>
                    ))}
                    <li className="pt-2">
                      <Link href="/admissions" className="text-blue-600 text-xs font-medium hover:underline">
                        View All Admissions →
                      </Link>
                    </li>
                  </ul>
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-3 flex items-center gap-2">
                    <span className="text-green-600">📊</span> Latest Results
                  </h3>
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="pt-2">
                      <Link href="/results" className="text-blue-600 text-xs font-medium hover:underline">
                        View All Results →
                      </Link>
                    </li>
                  </ul>
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-3 flex items-center gap-2">
                    <span className="text-orange-600">📅</span> Latest Date Sheets
                  </h3>
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="pt-2">
                      <Link href="/date-sheets" className="text-blue-600 text-xs font-medium hover:underline">
                ...
                <div>
                  <h3 className="font-bold text-gray-800 mb-3 flex items-center gap-2">
                    <span className="text-purple-600">💰</span> Latest Scholarships
                  </h3>
                  <ul className="space-y-2 text-sm">
                    ...
                    <li className="pt-2">
                      <Link href="/scholarships" className="text-blue-600 text-xs font-medium hover:underline">
