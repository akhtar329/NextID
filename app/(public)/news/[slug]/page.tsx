...
export async function generateMetadata({ params }: { params: Promise<{ slug: string }> }): Promise<Metadata> {
  ...
  const seoKeywords = newsItem.metaKeywords || `${newsItem.title}, education news Pakistan, ${newsItem.category} news, latest updates`;
  ...
  return {
    ...
    openGraph: {
      ...
      authors: newsItem.authorName ? [newsItem.authorName] : undefined,
...
async function NewsContent({ slug }: { slug: string }) {
  ...
  const jsonLd = generateJsonLd({
    ...
    description: newsItem.excerpt || `Read latest education news: ${newsItem.title}`,
    url: `https://www.nextid.pk/news/${newsItem.slug}`,
    image: newsItem.featuredImage || undefined,
